...
class Query {
   ...
   * @var [string]
   */
  private $AVAILABLE_TYPES = array( 'SELECT', 'UPDATE', 'DELETE', 'INSERT' );
   ...
   */
  public function select($fields = array(), $table = '', $where = array()){
    $this->type = 'SELECT';
    $this->fields = $fields;
    $this->table = $table;
    $this->where = $where;
   ...
   * @return object             Instancia actual Query
   */
  public function andWhere($conditions = array()){
